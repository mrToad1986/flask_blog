...
# отображение всех записей блога
posts = Blueprint('posts', __name__)


@posts.route("/allpost")
@login_required  # переход к списку постов только после авторизации
def allpost():
...
# отображение содержимого записи блога
...
# изменение содержимого записи блога
